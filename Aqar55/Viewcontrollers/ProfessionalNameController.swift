//
//  ProfessionalNameController.swift
//  AQAR55
//
...
class ProfessionalNameController: UIViewController {
    ...
    @IBAction func tap_btnViewProfessionalProfile(_ sender: Any) {
        ...
        if globalDictGetFromViewInfo.count != 0{
            ...
            let userIdAsNormal = globalDictGetFromViewInfo.object(forKey: "userId") as? String ?? ""
            
            if userType == "Professional"{
                
                let checkExistance = globalDictGetFromViewInfo.object(forKey: "businessProfileExists") as? Bool ?? false
                
                if checkExistance == true{
                    
                    let bussinessId = globalDictGetFromViewInfo.object(forKey: "commanUserBusinessId") as? String ?? ""
                    
                    //professional
                    self.apiCallForGetParticularProfileInfo(profBusID: bussinessId, type: "business", idAsNormal: userIdAsNormal)
                    
                }
                else{
                    
                    let name = globalDictGetFromViewInfo.object(forKey: "fullName") as? String ?? ""
                    
                    CommonClass.sharedInstance.callNativeAlert(title: "", message: "\(name) did not submit the Business profile", controller: self)
                }
                
            }
            else{
                
                let checkExistance = globalDictGetFromViewInfo.object(forKey: "professionalProfileExists") as? Bool ?? false
                
                if checkExistance == true{
                    
                    let professionalId = globalDictGetFromViewInfo.object(forKey: "commanUserProfessionalId") as? String ?? ""
                    
                    //business
                    
                    self.apiCallForGetParticularProfileInfo(profBusID: professionalId, type: "professional", idAsNormal: userIdAsNormal)
                }
                else{
                    
                    let name = globalDictGetFromViewInfo.object(forKey: "fullName") as? String ?? ""
                    
                    CommonClass.sharedInstance.callNativeAlert(title: "", message: "\(name) did not submit the Professional profile", controller: self)
                }
...
extension ProfessionalNameController{
...
extension ProfessionalNameController : UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout{
...
extension ProfessionalNameController : UIScrollViewDelegate{
...
extension ProfessionalNameController:UITableViewDelegate , UITableViewDataSource{
                ...
                if self.connection.responseCode == 1{
                    ...
                    if status == 200{
                        ...
                        if let data = receivedData.object(forKey: "Data") as? NSDictionary{
                            ...
                            self.arrOfImages = data.object(forKey: "imagesFile") as? NSArray ?? []
                            ...
                            self.pageControl.numberOfPages = self.arrOfImages.count
                ...
                if self.connection.responseCode == 1{
                    ...
                    if status == 200{
                        ...
                        if let data = receivedData.object(forKey: "Data") as? NSDictionary{
                            ...
                            let vc = self.storyboard?.instantiateViewController(withIdentifier: "ViewBusinessProfessionalProfileVC") as! ViewBusinessProfessionalProfileVC
